...
%% loop
for crun = 1:nrun    
    inputs{1, crun} = cellstr(fullfile(dir_path, subj{crun}, assess{1})); % File Selector (Batch Mode): Directory - cfg_files % directory with the 1st level SPM.mat file and target directory for contrast files
end
