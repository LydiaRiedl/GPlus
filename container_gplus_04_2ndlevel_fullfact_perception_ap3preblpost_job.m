%-----------------------------------------------------------------------
% Job saved on 09-Nov-2020 13:56:34 by cfg_util (rev $Rev: 6460 $)
% spm SPM - SPM12 (6685)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = '<UNDEFINED>';
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(1).name = 'session';
...
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(2).name = 'abstractness';
...
matlabbatch{1}.spm.stats.factorial_design.des.fd.fact(3).name = 'gesture';
...
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(13).levels = [3
                                                                     1
                                                                     1];
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(13).scans = '<UNDEFINED>';
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(14).levels = [3
                                                                     1
                                                                     2];
...
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(16).levels = [3
                                                                     2
                                                                     1];
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(16).scans = '<UNDEFINED>';
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(17).levels = [3
                                                                     2
                                                                     2];
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(17).scans = '<UNDEFINED>';
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(18).levels = [3
                                                                     2
                                                                     3];
matlabbatch{1}.spm.stats.factorial_design.des.fd.icell(18).scans = '<UNDEFINED>';
