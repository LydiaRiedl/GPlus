...
%% subjects' IDs
subj = {'sub-si01', 'sub-si02', 'sub-si03', 'sub-si04', 'sub-si05', 'sub-si06', 'sub-si07', 'sub-si08', 'sub-si09', 'sub-si10', 'sub-si11', 'sub-si13', 'sub-si14', 'sub-si15', 'sub-si16', 'sub-si17', 'sub-si18', 'sub-si19', 'sub-si20', 'sub-si21', 'sub-sw01', 'sub-sw02', 'sub-sw03', 'sub-sw05', 'sub-sw07', 'sub-sw09', 'sub-sw10', 'sub-sw11', 'sub-sw12'}; % CHECK!
% DONE: 
...
jobfile = {'/YOUR/PATH/scrpts/container_gplus_02_1stlevel_perception_job.m'}; % CHECK! directory where the SPM-jobfile is stored
...
for crun = 1:nrun
    ...
    subj_path = fullfile(dir_path, subj{crun}, assess{2});  % creating a path of current subject's folder
    ...
    new_tgt_dir = mkdir(fullfile(tgt_path, subj{crun}, assess{2})) % naming the new directory after the current subject ID
    
    inputs{10, crun} = cellstr(fullfile(tgt_path, subj{crun}, assess{2})); % fMRI model specification: Directory - cfg_files % target directory where the SPM.mat file will be written
end
