...
%
% function [] = cluster_threshold_beta(x_matrix, y_matrix, slices, dim_xy, dim_z, FWHM (-> resampled FWHM from 2nd level!!!), dim_resampled, ...
%                                      mask_name, mask_bytes, mask_plot, p_corrected, p_voxel, iterations, savename)
%
...
% change working directory to scratch directory and doing Jens a favour ;)
addpath('/home/lydia/Schreibtisch/G+/explorative_Analysen/ap3/neural/2ndlevel_task-perception/group-g-s/ses-pre-post');
cd '/home/lydia/Schreibtisch/G+/explorative_Analysen/ap3/neural/2ndlevel_task-perception/group-g-s/ses-pre-post' 

cluster_threshold_beta(64, 64, 34, 3, 4, 10.3, 2, 'none', 0, 0, .05, .001, 100, 'ap3_bids_clusterthreshold_at_p-0.001_iter1000')
